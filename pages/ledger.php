...
if (isset($_POST['view_ledger'])) {
	...
	$en = mysqli_query($db, "SELECT enrol_id, lname, fname, mi, cr_acrnm, year
...
?>
	...
	<div style="" id="ledger_sheet">
		...
		<?php
		$semnum = mysqli_query($db, "SELECT sem_num FROM sems WHERE sem_code = {$_SESSION['sem_code']}");
		$semnumr = mysqli_fetch_row($semnum);
		...
		<div style="width: 306px; float: <?php echo $align; ?>; margin-top: 45px;" id="ledger_details">
			<table id="ledger" border=0 width="100%">
				...
				<tr>
					<td colspan="6">Course &amp; Year: <?php echo $course_year; ?></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					<td>Tuition Fees</td>
					<td style="text-align:center"><?php printf("%.2f", $cunits); ?></td>
					<td style="text-align:center"><?php printf("%.2f", $punits); ?></td>
					<td style="text-align:center"><?php printf("%.2f", $rate); ?></td>
					<td style="text-align:right"><?php printf("%.2f", $tuition); ?></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="4" width="240">Mat/Misc Fees</td>
					<td style="text-align:right"><?php printf("%.2f", $misc); ?></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="4" width="240">Lab Fees</td>
					<td style="text-align:right"><?php printf("%.2f", $labfees); ?></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="4" width="240">Energy Fee</td>
					<td style="text-align:right"><?php printf("%.2f", $energy); ?></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="4" width="240">Affiliation Fee</td>
					<td style="text-align:right"><?php printf("%.2f", $aff); ?></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="4" width="240">Seminar Fee</td>
					<td style="text-align:right"><?php printf("%.2f", $sem); ?></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="4" width="240">RLE Fee</td>
					<td style="text-align:right"><?php printf("%.2f", $rle); ?></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="4" width="240">Old Account</td>
					<td style="text-align:right"><?php printf("%.2f", $old); ?></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
					<td colspan="4" width="240">Others</td>
					<td style="text-align:right"><?php printf("%.2f", $other); ?></td>
					<td><?php printf("%.2f", $total); ?></td>
				</tr>
				<tr>
					<td colspan="4" width="240">Less: Entrance [OR# <?php echo $entrance_or; ?>]</td>
					<td style="text-align:right"><?php printf("%.2f", $entrance); ?></td>
					<td style="text-align:right"><?php printf("%.2f", $total - $entrance); ?></td>
				</tr>
			</table>
		</div>
