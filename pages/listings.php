...
<form method="post" action="" style="display: inline-block;float:left;">
List Category: 
...
<form method="post" action="">
    <input type="submit" value="Show All" name="submit_all"
        style="float: right;" />
</form>
</div>
...
if(isset($_POST['submit_all'])) {
    $list = mysql_query("SELECT stud_enrol.idnum, idext, cr_num, 
...
if(isset($_POST['submit_year_list'])){
	...
	switch($_REQUEST['year']){
		case 1 : $list_detail = "First Year"; break;
		case 2 : $list_detail = "Second Year"; break;
		case 3 : $list_detail = "Third Year"; break;
		case 4 : $list_detail = "Fourth Year"; break;
		case 'Q' : $list_detail = "Qualifying"; break;
		default : $list_detail = "Blank coursed"; break;
	}
	$list_detail = "List of " . $list_detail . " Students";
}
if(isset($_POST['submit_course_year_list'])){
	$list=mysql_query("SELECT idext, stud_enrol.idnum, cr_num, 
...
<input type="image" src="images/printButton.png" class="noprint"
		onclick="printThisDiv('printFrame','list_result')"
		style="float: right;">
<iframe id="printFrame" style="width: 0px; height: 0px; float: left; margin-left: -9999px"></iframe>
	...
	No. of records found: <?php echo mysql_num_rows($list); ?>
	</p>
</center>
...
<?php $n=0; $tpu=0; $tcu=0; while($lrow=mysql_fetch_assoc($list)) { ?>
	<tr>
...
<tr><td colspan="7" class="tfoot">&nbsp;</td></tr>
</table>
<?php } ?>	
</span>
