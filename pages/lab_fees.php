...
<table>
    ...
    <?php
    $cls = mysqli_query($db, "SELECT c.class_code, name, descript, punits, 
    ...
    while ($clsr = mysqli_fetch_assoc($cls)) { ?>
        <tr style="background: #fff;">
            ...
            <td style="border: 1px solid #333; color: #333">
                <input type="text" id="<?php echo $clsr['class_code']; ?>" value="<?php echo $clsr['lab_fee']; ?>" onChange="
                ...
                " onFocus="this.select();" style="width: 50px; border: 1px solid #777; font-size: 11px; 
