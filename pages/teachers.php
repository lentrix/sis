...
if (isset($_POST['submit_add_teacher'])) {
	mysqli_query($db, "INSERT INTO teacher (lname,fname,mi,clg_no)
...
if (isset($_POST['confirm_delete_teacher'])) {
	mysqli_query($db, "DELETE FROM teacher WHERE tch_num={$_REQUEST['tch_num']}");
	if (mysqli_error($db)) echo "<div class='error'>" . mysqli_error($db) . "</div>";
...
<div id="teacher_list" style="height: 180px;">
	<div style="float: left; height: 160px;">
		<form method="post" action="">
			...
			FROM teacher WHERE clg_no={$_SESSION['clg_no']}",
				"",
	...
	<div style="margin-left: 20px; float: left;background:#fff; height: 130px;">
		<form method="post" action="">
			<table>
				...
				<tr>
					<td>M.I.:</td>
					<td><input type="text" name="mi" maxlength="2" size="1">
				<tr>
